                        ...
                        <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href="{{ URL::to('/category-by-product/'.$row->id) }}">{{$row->category_name}}</a></h4>
                                </div>
                            </div>
                            @endforeach
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    @foreach($brands as $row)
                                        <li><a href="{{ URL::to('/product-by-brands/'.$row->id) }}"> <span class="pull-right">(50)</span>{{ $row->manufacture_name}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div><!--/brands_products-->
