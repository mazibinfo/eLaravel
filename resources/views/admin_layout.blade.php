...
<body>
					...
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							...
							<ul>
								...
								<li><a class="submenu" href="{{URL::to('/all-manufacture')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Brands</span></a></li>
							</ul>	
						</li>
						<li>
						...
						<li>
							<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Silder</span><span class="label label-important"></span></a>
							<ul>
	...
	<script>
		$(document).on("click","#active", function(e){
			e.preventDefault();
			var link = $(this).attr("href");
			bootbox.confirm("Are you want to Active?", function(confirmed){
	...
	<script>
		$(document).on("click","#inactive", function(e){
			e.preventDefault();
			var link = $(this).attr("href");
			bootbox.confirm("Are you want to Inactive?", function(confirmed){
